...
\emph{Manuscript last updated: 2025-06-05 16:41:09.902697}
...
Naturally, the majority of shortlisted trials cover advanced (locally
...
\textbf{55}. Weberpals J: Encore.analytics: Functions and wrappers to
streamline complex analytic workflows in real-world data studies based
on the ENCORE trial emulation project {[}Internet{]}, 2025Available
from: \url{https://github.com/janickweberpals/encore.analytics}

\bibitem[\citeproctext]{ref-gtsummary}
\textbf{56}. Sjoberg DD, Whiting K, Curry M, et al: Reproducible summary
tables with the gtsummary package {[}Internet{]}13:570--580,
2021Available from: \url{https://doi.org/10.32614/RJ-2021-053}

\bibitem[\citeproctext]{ref-ggsurvfit}
\textbf{57}. Sjoberg DD, Baillie M, Fruechtenicht C, et al: Ggsurvfit:
Flexible time-to-event figures {[}Internet{]}, 2024Available from:
\url{https://github.com/pharmaverse/ggsurvfit}

\bibitem[\citeproctext]{ref-gaber2024mystifying}
\textbf{58}. Gaber CE, Ghazarian AA, Strassle PD, et al: De-mystifying
