...
The *Emulation of Comparative Oncology Trials with Real-world Evidence* (**ENCORE**) project aims to extend this work to the field of oncology which comes with its own unique challenges that are not necessarily comparable with learnings from other disease areas and which must be systematically explored and understood.
